...
/**
 * @brief Optional delegate method that gets called when the session id changed.
 *
 * @param sessionId The session id that has been set.
 */
- (void)metrixSessionIdChanged:(nullable NSString *)sessionId;
